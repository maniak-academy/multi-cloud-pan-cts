...
#   #   device_index         = 0
#   # }
#   user_data              = base64encode(templatefile("${path.module}/scripts/aws-consul-tf-sync.sh", { 
#     consul_server_ip = data.terraform_remote_state.environment.outputs.aws_consul_public_name,
#     vault_token = "root", 
...
# resource "aws_security_group" "awscts" {
#   name   = "awscts"
